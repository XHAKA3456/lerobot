...
def make_flowmatching_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for the FlowMatching policy.

    The pre-processing pipeline prepares input data for the model by:
    1. Renaming features to match pretrained configurations.
    2. Adding a batch dimension.
    3. Moving data to the specified device.
    ...
    Args:
        config: The configuration object for the FlowMatching policy.
