...
@PreTrainedConfig.register_subclass("flowmatching_tc")
@dataclass
class FlowMatchingTCConfig(PreTrainedConfig):
    """Configuration for the Flow Matching Task-Conditioned policy.
